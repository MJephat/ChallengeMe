...
export default function QRCodePage() {
  ...
  const pay = async () => {
    ...
    try {
      setLoading(true);
      setMessage("");
       await axios.post("https://8d87-2c0f-2f00-5b-76c0-91a1-934d-e28a-d7c1.ngrok-free.app/pay/1100", {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* QR Code */}
      <QRCodeCanvas
       value="https://8d87-2c0f-2f00-5b-76c0-91a1-934d-e28a-d7c1.ngrok-free.app/pay/1100"
